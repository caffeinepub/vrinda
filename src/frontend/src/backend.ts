...
export class Backend implements backendInterface {
    ...
    async likeSong(arg0: string, arg1: string, arg2: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.likeSong(arg0, arg1, arg2);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async savePreferences(arg0: string, arg1: Array<string>): Promise<void> {
        if (this.processError) {
            try {
    ...
    async unlikeSong(arg0: string): Promise<void> {
        if (this.processError) {
            try {
