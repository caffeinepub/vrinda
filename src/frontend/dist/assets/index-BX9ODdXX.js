...
var s = null;
var u = /* @__PURE__ */ new Map(), c = /* @__PURE__ */ new Map();
function l(t2, e2) {
  var n2 = g(t2, e2);
  return u.get(n2);
}
...
}, encodeString: rt, decodeString: ot, locToIndex: at, indexToLoc: it }), ut = function() {
  function t2(t3, e2) {
...
var Ct, Et, Rt, It, kt, St = function(t2) {
...
var Ot, Mt = Object.freeze({ makeTypesMatch: Nt, assertTypesMatch: Ft, isTensorInList: function(t2, e2) {
  return e2.some(function(e3) {
    return e3.id === t2.id;
  });
}, getTensorsInContainer: _t }), Bt = function() {
  function t2() {
...
var Vt, zt, Gt, Ht = {}, qt = { alpha: false, antialias: false, premultipliedAlpha: false, preserveDrawingBuffer: false, depth: false, stencil: false, failIfMajorPerformanceCaveat: true };
function Kt(t2, e2) {
  Ht[t2] = e2;
}
function jt(t2) {
...
var Ge = Object.freeze({ callAndCheck: Jt, canBeRepresented: ee, getWebGLErrorMessage: ne, getExtensionOrThrow: re, createVertexShader: oe, createFragmentShader: ae, createProgram: ce, linkProgram: le, validateProgram: he, createStaticVertexBuffer: fe, createStaticIndexBuffer: de, getNumChannels: function() {
  ...
  se = null;
}, getMaxTexturesInShader: Me, getWebGLDisjointQueryTimerVersion: Be, hasExtension: Pe, isWebGLVersionEnabled: Le, isCapableOfRenderingToFloatTexture: We, isDownloadFloatTextureEnabled: Ue, isWebGLFenceEnabled: ze }), He = i();
function qe() {
  i().set("PROD", true);
}
function Ke() {
...
var nr = er(function(t2) {
  !function(t3, e2, n2) {
    ...
    e2 && e2.exports ? e2.exports = a2 : this.alea = a2;
  }(0, t2);
}), rr = er(function(t2) {
  !function(t3, e2, n2) {
    function r2(t4) {
    ...
    e2 && e2.exports ? e2.exports = a2 : this.xor128 = a2;
  }(0, t2);
}), or = er(function(t2) {
  !function(t3, e2, n2) {
    function r2(t4) {
    ...
    e2 && e2.exports ? e2.exports = a2 : this.xorwow = a2;
  }(0, t2);
}), ar = er(function(t2) {
  !function(t3, e2, n2) {
    function r2(t4) {
    ...
    e2 && e2.exports ? e2.exports = a2 : this.xorshift7 = a2;
  }(0, t2);
}), ir = er(function(t2) {
  !function(t3, e2, n2) {
    function r2(t4) {
    ...
    e2 && e2.exports ? e2.exports = a2 : this.xor4096 = a2;
  }(0, t2);
}), sr = er(function(t2) {
  !function(t3, e2, n2) {
    function r2(t4) {
    ...
    e2 && e2.exports ? e2.exports = a2 : this.tychei = a2;
  }(0, t2);
}), ur = er(function(t2) {
  !function(e2, n2) {
...
var Xr = Object.freeze({ prepareAndValidate: jr }), Yr = 30;
function $r(t2) {
...
}, Da = "return areal * breal - aimag * bimag;", Ta = "return areal * bimag + aimag * breal;", Na = function(t2, e2, n2) {
...
}, Fa = "return a + b;", _a = "return a - b;", Oa = "return a * b;", Ma = "return (a < 0.) ? b * a : a;", Ba = function(t2, e2, n2) {
...
}, fi = "return real * expR - imag * expI;", di = "return real * expI + imag * expR;", pi = function(t2, e2, n2) {
...
var ts = function(t2, e2, n2) {
  ...
  this.variableNames = ["updates", "indices", "defaultValue"], this.outputShape = a2;
...
}, bs = 1.7580993408473768, ws = 1.0507009873554805, Cs = function(t2, e2) {
...
var Zs = function(t2) {
  ...
  return e(o2, t2), o2.prototype.numDataIds = function() {
    ...
    var a2 = t3.shape[0], i2 = t3.shape[1], s2 = function(t4, e3) {
      ...
      return n3;
    }(i2, o3), u2 = new us({ windowSize: s2, inSize: i2, batchSize: a2, numSegments: o3 }), c2 = this.compileAndRun(u2, [t3, n2], r2);
    ...
    var o3 = Zr(0, t3, n2), a2 = o3.sliceRank, i2 = o3.numUpdates, s2 = o3.strides, u2 = o3.outputSize, c2 = new ss(i2, a2, t3.rank, e2.rank, s2, [u2, 1]);
...
} }), ju = An({ batchNorm_: Uu }), Xu = An({ batchNorm2d_: Pu }), Yu = An({ batchNorm3d_: Lu }), $u = An({ batchNorm4d_: Wu });
...
} }), Xc = An({ conv2dDerInput_: Vc }), Yc = An({ depthwiseConv2d_: function(t2, e2, n2, r2, o2, a2, i2) {
  void 0 === a2 && (a2 = [1, 1]);
...
} }), Oh = Object.freeze({ resizeBilinear: Sh, resizeNearestNeighbor: Ah, nonMaxSuppression: Dh, nonMaxSuppressionAsync: Th, nonMaxSuppressionWithScore: Nh, nonMaxSuppressionWithScoreAsync: Fh, cropAndResize: _h }), Mh = function(t2, e2) {
...
for (var jh = 0, Xh = [{ kernelName: "NonMaxSuppressionV5", backendName: "cpu", kernelFunc: function(t2) {
...
for (var Jh = 0, Zh = [{ kernelName: "FromPixels", backendName: "webgl", kernelFunc: function(t2) {
...
for (var tf = 0, ef = [{ kernelName: "Square", gradFunc: function(t2, e2) {
  var n2 = e2[0];
  return { x: function() {
...
var sf = { float32: 4, int32: 4, uint16: 2, uint8: 1, bool: 1 }, uf = 4;
function cf(t2, e2) {
...
var nd, rd = An({ confusionMatrix_: function(t2, e2, n2) {
...
var ld = Object.freeze({ Serializable: sd, SerializationMap: ud, registerClass: cd }), hd = 1e-3, fd = 0.1;
function dd() {
...
}, MathBackendWebGL: Zs, setWebGLContext: Kt, GPGPUContext: Bi }), xd = function(t2) {
  function o2() {
    ...
    return n(this, void 0, void 0, function() {
      ...
      return r(this, function(n2) {
        switch (n2.label) {
          ...
          case 1:
            return t3 = n2.sent(), e2 = t3.length / 2, this.accumulatedGrads = t3.slice(0, e2).map(function(t4) {
      ...
      return r(this, function(e2) {
        switch (e2.label) {
          case 0:
            return [4, this.extractIterations(t3)];
          case 1:
            return t3 = e2.sent(), this.accumulatedGrads = t3.map(function(t4) {
              return { originalName: t4.name, variable: t4.tensor.variable(false) };
            }), [2];
        }
      });
      ...
      return r(this, function(r2) {
        switch (r2.label) {
          ...
          case 1:
            ...
            }), e2 = t3.length / 2, this.accumulatedFirstMoment = t3.slice(0, e2).map(function(t4) {
              return { originalName: t4.name, variable: t4.tensor.variable(false) };
      ...
      return r(this, function(e2) {
        switch (e2.label) {
          case 0:
            return [4, this.extractIterations(t3)];
          case 1:
            return t3 = e2.sent(), this.accumulations = t3.map(function(t4) {
              return { originalName: t4.name, variable: t4.tensor.variable(false) };
            }), [2];
        }
      });
      ...
      return r(this, function(n2) {
        switch (n2.label) {
          case 0:
            return [4, this.extractIterations(t3)];
          case 1:
            return t3 = n2.sent(), e2 = this.centered ? t3.length / 3 : t3.length / 2, this.accumulatedMeanSquares = t3.slice(0, e2).map(function(t4) {
              return { originalName: t4.name, variable: t4.tensor.variable(false) };
...
}(), Ad = { sgd: Sd.sgd, momentum: Sd.momentum, adadelta: Sd.adadelta, adagrad: Sd.adagrad, rmsprop: Sd.rmsprop, adamax: Sd.adamax, adam: Sd.adam }, Dd = "undefined" != typeof requestAnimationFrame ? requestAnimationFrame : "undefined" != typeof setImmediate ? setImmediate : function(t2) {
  return t2();
};
function Td() {
...
const tfCore_esm = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
...
function normalize$1(x2, meanRgb) {
  return Ze(function() {
...
function depthwiseSeparableConv$1(x2, params, stride) {
  return Ze(function() {
...
function denseBlock3(x2, denseBlockParams, isFirstLayer) {
  ...
  return Ze(function() {
    var out1 = Bl(isFirstLayer ? rc(qc(x2, denseBlockParams.conv0.filters, [2, 2], "same"), denseBlockParams.conv0.bias) : depthwiseSeparableConv$1(x2, denseBlockParams.conv0, [2, 2]));
...
function denseBlock4(x2, denseBlockParams, isFirstLayer, isScaleDown) {
  ...
  return Ze(function() {
    var out1 = Bl(isFirstLayer ? rc(qc(x2, denseBlockParams.conv0.filters, isScaleDown ? [2, 2] : [1, 1], "same"), denseBlockParams.conv0.bias) : depthwiseSeparableConv$1(x2, denseBlockParams.conv0, isScaleDown ? [2, 2] : [1, 1]));
    var out2 = depthwiseSeparableConv$1(out1, denseBlockParams.conv1, [1, 1]);
    var in3 = Bl(rc(out1, out2));
    var out3 = depthwiseSeparableConv$1(in3, denseBlockParams.conv2, [1, 1]);
...
function convLayer$1(x2, params, padding, withRelu) {
  if (padding === void 0) {
    padding = "same";
  }
  if (withRelu === void 0) {
...
function extractorsFactory$9(extractWeights, paramMappings) {
  ...
  function extractDenseBlock4Params(channelsIn, channelsOut, mappedPrefix, isFirstLayer) {
    ...
    var _a2 = extractDenseBlock3Params(channelsIn, channelsOut, mappedPrefix, isFirstLayer), conv0 = _a2.conv0, conv1 = _a2.conv1, conv2 = _a2.conv2;
...
function extractParamsFromWeigthMap$5(weightMap, numMainBlocks) {
  var paramMappings = [];
  var _a2 = loadParamsFactory(weightMap, paramMappings), extractConvParams = _a2.extractConvParams, extractSeparableConvParams = _a2.extractSeparableConvParams, extractReductionBlockParams = _a2.extractReductionBlockParams, extractMainBlockParams = _a2.extractMainBlockParams;
...
function conv$1(x2, params, stride) {
...
function reductionBlock(x2, params, isActivateInput) {
  ...
  out = rc(out, conv$1(x2, params.expansion_conv, [2, 2]));
  return out;
}
function mainBlock(x2, params) {
  var out = depthwiseSeparableConv$1(Bl(x2), params.separable_conv0, [1, 1]);
  out = depthwiseSeparableConv$1(Bl(out), params.separable_conv1, [1, 1]);
...
function convLayer(x2, params, strides, withRelu, padding) {
  if (padding === void 0) {
    padding = "same";
  }
...
function conv(x2, params) {
  return convLayer(x2, params, [1, 1], true);
}
function convNoRelu(x2, params) {
  return convLayer(x2, params, [1, 1], false);
}
function convDown(x2, params) {
  return convLayer(x2, params, [2, 2], true, "valid");
}
function extractorsFactory$7(extractWeights, paramMappings) {
  ...
  function extractConvLayerParams(numFilterValues, numFilters, filterSize, mappedPrefix) {
    var conv2 = extractConvParams(numFilterValues, numFilters, filterSize, mappedPrefix + "/conv");
    var scale2 = extractScaleLayerParams(numFilters, mappedPrefix + "/scale");
    return { conv: conv2, scale: scale2 };
  }
...
function extractParamsFromWeigthMap$3(weightMap) {
  var paramMappings = [];
  var _a2 = extractorsFactory$6(weightMap, paramMappings), extractConvLayerParams = _a2.extractConvLayerParams, extractResidualLayerParams = _a2.extractResidualLayerParams;
...
function extractParamsFromWeigthMap$2(weightMap) {
  var paramMappings = [];
  var _a2 = extractorsFactory$4(weightMap, paramMappings), extractMobilenetV1Params = _a2.extractMobilenetV1Params, extractPredictionLayerParams = _a2.extractPredictionLayerParams;
...
function boxPredictionLayer(x2, params) {
  return Ze(function() {
    ...
    var boxPredictionEncoding = Or(convLayer$1(x2, params.box_encoding_predictor), [batchSize, -1, 1, 4]);
    var classPrediction = Or(convLayer$1(x2, params.class_predictor), [batchSize, -1, 3]);
    return {
...
function extractorsFactory$3(extractWeights, paramMappings) {
  ...
  function extractConvWithBatchNormParams(channelsIn, channelsOut, mappedPrefix) {
    var conv2 = extractConvParams(channelsIn, channelsOut, 3, mappedPrefix + "/conv");
    var bn2 = extractBatchNormParams(channelsOut, mappedPrefix + "/bn");
    return { conv: conv2, bn: bn2 };
  }
  var extractSeparableConvParams = extractSeparableConvParamsFactory(extractWeights, paramMappings);
  return {
    extractConvParams,
...
function extractorsFactory$2(weightMap, paramMappings) {
  ...
  function extractConvWithBatchNormParams(prefix) {
    var conv2 = extractConvParams(prefix + "/conv");
...
function extractParamsFromWeigthMap$1(weightMap, config) {
  var paramMappings = [];
  var _a2 = extractorsFactory$2(weightMap, paramMappings), extractConvParams = _a2.extractConvParams, extractConvWithBatchNormParams = _a2.extractConvWithBatchNormParams, extractSeparableConvParams = _a2.extractSeparableConvParams;
  var params;
  if (config.withSeparableConvs) {
...
var TinyYolov2Base = (
  ...
  function(_super) {
    ...
    TinyYolov2Base2.prototype.runMobilenet = function(x2, params) {
      var out = this.config.isFirstLayerConv2d ? leaky(convLayer$1(x2, params.conv0, "valid", false)) : depthwiseSeparableConv(x2, params.conv0);
      out = hl(out, [2, 2], [2, 2], "same");
    ...
    TinyYolov2Base2.prototype.forwardInput = function(input, inputSize) {
      ...
      return Ze(function() {
        ...
        batchTensor = _this.config.meanRgb ? normalize$1(batchTensor, _this.config.meanRgb) : batchTensor;
        ...
        return __generator(this, function(_b) {
          switch (_b.label) {
            ...
            case 3:
              ...
              indices = nonMaxSuppression$1(boxes.map(function(box) {
...
function extractParamsFromWeigthMap(weightMap) {
  var paramMappings = [];
  var _a2 = extractorsFactory(weightMap, paramMappings), extractPNetParams = _a2.extractPNetParams, extractRNetParams = _a2.extractRNetParams, extractONetParams = _a2.extractONetParams;
  var pnet = extractPNetParams();
  var rnet = extractRNetParams();
  var onet = extractONetParams();
  disposeUnusedWeightTensors(weightMap, paramMappings);
...
function sharedLayer(x2, params, isPnet) {
  ...
  return Ze(function() {
    var out = convLayer$1(x2, params.conv1, "valid");
...
function PNet(x2, params) {
  return Ze(function() {
    ...
    var conv2 = convLayer$1(out, params.conv4_1, "valid");
    var max = wr(Sl(conv2, 3), 3);
    var prob = go(Cc(conv2, max), 3);
...
function stage1(imgTensor, scales, scoreThreshold, params, stats) {
  ...
  var boxesForScale = pnetOutputs.map(function(_a2) {
    ...
    var ts3 = Date.now();
    var indices2 = nonMaxSuppression$1(boundingBoxes.map(function(bbox) {
      return bbox.cell;
  ...
  if (allBoxes.length > 0) {
    var ts2 = Date.now();
    var indices = nonMaxSuppression$1(allBoxes.map(function(bbox) {
      return bbox.cell;
...
export {
  ...
  mtcnn,
  nets,
  nonMaxSuppression$1 as nonMaxSuppression,
